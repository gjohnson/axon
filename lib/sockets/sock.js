...
function Socket() {
  ...
  this.msgpool = new FreeList('messages', 1000, function(){
    var msg = new Message();
    return msg;
  });
}
...
Socket.prototype.addSocket = function(sock){
  ...
  // parse incoming
  sock.ondata = function(buf, off, end){
    parser.write(buf.slice(off, end));
  };
